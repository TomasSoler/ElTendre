    ...
    $("#contacto").submit(function(){
        ...
        $.ajax({
            ...
            async: 'true',
                ...
                error: function(json){
                    console.log(json.message);
                    alert('Ha habido un error. Prueba dentro de unos momentos');
                    $("body").css("cursor", "default");
                    $('#send').click(function(){
                        $("#contacto").submit();
                    });
...
function STDGallery() {
    ...
    $gallery.description = $('#STGalery.STGDescription');
    $gallery.content = $('#STGallery').find('.STGContent');
    $gallery.counter = 0;
    ...
    $('#thumbs-next').click(function(){
        ...
        if ( $('#STGThumbs ul').is(':animated') ) {} else {
            if(counter <= 5 ) {
                $('#STGThumbs ul').animate({
    ...
    var mt = parseInt($('#STGThumbs ul img').css('margin-top'));
    $('#STGThumbs ul img').each(function(){
